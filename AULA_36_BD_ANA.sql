...
select * from acoes where patrimonio_liquido>100000000000 and dividend_yield>0.2 and pvp<5 and pl<25;

select * from acoes where patrimonio_liquido>100000000000 order by patrimonio_liquido desc;